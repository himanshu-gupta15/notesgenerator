...
function Navbar() {
  ...
  return (
    <motion.div
      ...
      className="relative z-20 mx-6 mt-6 rounded-2xl bg-gradient-to-br from-black/90 via-black/90 backdrop-blur-2xl border border-white/10 shadow-[0_22px_55px_rgba(0,0,0,0.75)] flex items-center justify-between px-8 py-4"
    >
      {/* Logo Section */}
            ...
            {showCredits && (
              ...
              >
                ...
                <p className="text-sm text-gray-300 mb-4">
                  Use credits to generate notes with AI.
                </p>
                <button
