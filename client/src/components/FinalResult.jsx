...
function FinalResult({result}) {
  ...
  if(!result||!result.subTopics||!result.questions||!result.questions.short||!result.questions.long||!result.revisionPoints){
    return null;
  }
  return (
    <div className='mt-6 p-3 space-y-10 bg-white'>
        <div className='flex flex-col md:flex-row md:items-center md:justify-between gap-4'>
            <h2 className='text-3xl font-bold bg-gradient-to-r from-inigo-600 bg-clip-text text-transparent'>
                📘 Generated Notes
            </h2>
          <div className='flex gap-3'>
           <button
  onClick={()=>setQuickRevision(prev=>!prev)}
...
>
  {quickRevision?'Exit Revision Mode':'Quick Revision (5 min)'}
        ...
        {!quickRevision &&<section>
          ...
          {!quickRevision &&<section
          className='rounded-xl bg-gradient-to-r from-green-100 to-green-50 border border-green-200 p-6'
          >
           <h3 className='font-bold text-green-700 mb-3 text-lg'>
             ⚡️ Exam Quick Revision Points
           </h3>
          ...
          {result.diagram?.data && <section>
            ...
            <p className='mt-3 text-xs text-gray-500 italic'>
              ⬇️ If you need this diagram for future reference or revision, you can save it by taking a screenshot.
            </p>
            </section>}
            ...
            <section>
              ...
              <p className='mt-3 text-xs text-gray-500 italic'>
              ⬇️ If you need this Chart for future reference or revision, you can save it by taking a screenshot.
            </p>
              </section> 
            }
         ...
         <p className='font-medium mt-4'>Short Questions:</p>
         <ul>
