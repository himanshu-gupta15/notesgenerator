  ...
  return (
   ...
   />
    ...
    <PricingCard
     ...
     amount={500}
     credits="300Credits"
     description="For dedicated learners aiming high"
     features={[
...
function PricingCard({
  ...
  return (
    ...
    className={
      `
      relative cursor-pointer rounded-xl p-6 bg-white border transition ${
        isSelected 
        ?"border-black"
        :popular 
        ?"border-indigo-500"
    ...
    >
     ...
     <button disabled={isPayingThisCard} onClick={(e)=>{
      e.stopPropagation();
      onBuy(amount)
     }} className={`
     ...
     `}> 
    {isPayingThisCard ?"Redirectiong..." :"Buy Now"}
     </button>
     <ul>
      {features.map((f,i)=>{
